    ...
    public Loader<String[]> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String[]>(this) {
            ...
            public String[] loadInBackground() {
                ...
                URL wUrl = NetworkUtils.buildUrl(location);
                try {
                    String data = NetworkUtils.getResponseFromHttpUrl(wUrl);
                    String[] data1 = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, data);
                    return data1;
                } catch (Exception e) {
                    e.printStackTrace();
                    return null;
            ...
            @Override
            public void deliverResult(String[] data2) {
                wData = data2;
