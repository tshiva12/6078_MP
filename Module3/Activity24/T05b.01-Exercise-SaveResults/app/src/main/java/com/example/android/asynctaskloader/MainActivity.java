...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            String texturl = savedInstanceState.getString(SEARCH_QUERY_URL_EXTRA);
            String jsonData = savedInstanceState.getString(SEARCH_RESULTS_RAW_JSON);
            mUrlDisplayTextView.setText(texturl);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(SEARCH_QUERY_URL_EXTRA, url);
        ...
        outState.putString(SEARCH_RESULTS_RAW_JSON, jsondata);
    }
}