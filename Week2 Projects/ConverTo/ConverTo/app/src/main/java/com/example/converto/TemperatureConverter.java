...
//        }
    ...
    private void fillSpinnerWith(){
        unitsarr.clear();
        unitsarr.add(getResources().getString(R.string.c));
        unitsarr.add(getResources().getString(R.string.f));
    ...
    public double Convert(String from, String to, double input) {
        if((from.equals(this.getApplicationContext().getResources().getString(R.string.c)) && to.equals((this.getApplicationContext().getResources().getString(R.string.f))))){
            double result =  (double)((input*9/5)+32);
            return result;
        }

        else if((from.equals(this.getApplicationContext().getResources().getString(R.string.f)) && to.equals((this.getApplicationContext().getResources().getString(R.string.c))))){
            double result =  (double)((input-32)*5/9);
            return result;
        }
