...
public class MainActivity extends AppCompatActivity {
    ...
    public class NetworkRequest extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String...str1) {
            ...
            try {
                String a = NetworkUtils.getResponseFromHttpUrl(weatherURL);
                String[] bdata = OpenWeatherJsonUtils
                        .getSimpleWeatherStringsFromJson(MainActivity.this, a);
                return bdata;
            } catch (Exception e) {
                e.printStackTrace();
                return null;
        ...
        protected void onPostExecute(String[] wdata) {
            if (wdata != null) {
                for (String str1:wdata) {
                    mWeatherTextView.append((str1) + "\n\n\n");
                }
            }
        }
    }
